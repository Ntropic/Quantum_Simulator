...
[init_original main_original connector_original outit_original gate_names]=Split_Trot_Pauli_Gray_Gates(n);
...
Gates2Circ2Preview(init_original,elem_gates,other_gates,['test_gray_circ_exp_init_orig_n_' num2str(n)],'gate=expansion',1,150);
%Gates2Circ2Preview(main_original,elem_gates,other_gates,['test_gray_circ_exp_main_orig_n_' num2str(n)],'gate=expansion',1,150);
Gates2Circ2Preview(connector_original,elem_gates,other_gates,['test_gray_circ_exp_connector_orig_n_' num2str(n)],'gate=expansion',1,150);
Gates2Circ2Preview(outit_original,elem_gates,other_gates,['test_gray_circ_exp_outit_orig_n_' num2str(n)],'gate=expansion',1,150);
