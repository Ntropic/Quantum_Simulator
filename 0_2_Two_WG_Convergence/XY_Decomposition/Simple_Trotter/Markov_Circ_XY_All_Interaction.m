...
for l=1:steps
    ...
    %average_fidelity
    [F_av(l) F_av_ind(l)]=Hilbert_Schmidt(rho_i,rho,index);
    time_l(l)=toc(timer);
end 
...
legend({'\mathrm{O}(t^2)'})
axis tight;
%matlab2tikz('Average_Error_Rate_Convergence1_50.tex')
drawnow;
...
axis tight;
%matlab2tikz('Average_Error_Rate_Convergence_order1_50.tex')
%drawnow;