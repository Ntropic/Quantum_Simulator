%Higher_Order_Trotter_WG_Plot_Test_Compare_Depth.m
clc;
clear all;
close all;
...
[seq,d_seq,gate,step_gate]=Higher_Trotter(t,steps,pattern,'',circ_string,circ_string_step,n,anc_size,gates_names,gates_indexes);
%Do Trotter steps
...
WG_Plot2PColor_Compare( ket_string,ket_string2,phi_i_red,phi_a_red,ts,ta,0,0,5);