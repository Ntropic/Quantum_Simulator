%Pauli_Ladder_Permutations_trot_steps_higher_distribution.m
...
%Photon number
n_max=7;
how_many=1000; %The first how many permutations (maximum)
n_bins=100;
t=pi/4;
plotting=1;
trott_type=1;   %0=trotter, 1=strang, 2,else=higher order
rec_order=0;
...
for n=2:n_max
    ...
    if plotting==1
        ...
        matlab2tikz(['Histograms\pretty_histogram_' num2str(n) '_tt_' num2str(trott_type) '_r_' num2str(rec_order,'%i_') '.tex'],'parseStrings',false,'width','6.2cm','height','4.5cm')
        drawnow()
    end
