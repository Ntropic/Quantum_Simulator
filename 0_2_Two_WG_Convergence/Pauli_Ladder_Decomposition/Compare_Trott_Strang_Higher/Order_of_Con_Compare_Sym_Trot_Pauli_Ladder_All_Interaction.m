...
higher_name=['higher_compare_n_' num2str(min(n_m)) '_to_' num2str(max(n_m)) '_s_' num2str(steps) '_r_' num2str(r_h) '_t_' num2str(t) '_pauli_gray'];
higher_name2=['higher_compare_n_' num2str(min(n_m)) '_to_' num2str(max(n_m)) '_s_' num2str(steps) '_r_' num2str(r_h2) '_t_' num2str(t) '_pauli_gray'];
