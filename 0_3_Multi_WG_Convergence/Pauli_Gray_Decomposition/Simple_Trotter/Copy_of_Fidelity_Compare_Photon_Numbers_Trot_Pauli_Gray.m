...
name=['mwg_trot_compare_fid_n_' num2str(min(n_m)) '_to_' num2str(max(n_m)) '_s_' num2str(steps) '_t_' num2str(t) '_N_' num2str(max(N_m)) '_pauli_gray'];
...
for h=1:length(N_m)
    ...
    for i=1:length(n_m)
        ...
        for l=1:steps
            ...
            U_approx=U2MWG_Trotter(H_parts,t,l,N);
