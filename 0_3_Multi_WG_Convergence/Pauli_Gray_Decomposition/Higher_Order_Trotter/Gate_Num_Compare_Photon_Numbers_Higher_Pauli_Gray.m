...
for op=3
    ...
    for rec_order=0:3;
        ...
        name=['mwg_higher_compare_n_' num2str(min(n_m)) '_to_' num2str(max(n_m)) '_s_' num2str(steps) '_t_' num2str(t) '_r_' num2str(rec_order) '_N_' num2str(max(N_m)) '_pauli_gray'];
        ...
        for h=1:length(N_m)
            ...
            for i=1:length(n_m)
                ...
                for l=1:steps
                    ...
                    trott_gate=MWG_Higher_Trotter_InOut(t,l,rec_order,N,[],gate_name,circ_str,sizle,anc_size,gate_names);
