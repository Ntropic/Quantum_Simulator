...
name=['higher_compare_n_' num2str(min(n_m)) '_to_' num2str(max(n_m)) '_r_' num2str(r) '_N_' num2str(max(N_m)) '_s_' num2str(steps) '_t_' num2str(t) '_pauli_gray'];
name2=['higher_compare_n_' num2str(min(n_m2)) '_to_' num2str(max(n_m2)) '_r_' num2str(r) '_N_' num2str(max(N_m2)) '_s_' num2str(steps) '_t_' num2str(t) '_pauli_gray'];
