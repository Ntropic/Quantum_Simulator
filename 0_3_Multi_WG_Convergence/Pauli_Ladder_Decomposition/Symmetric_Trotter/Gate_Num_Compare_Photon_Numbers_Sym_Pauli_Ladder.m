...
for op=3
    ...
    %Iteration time
    t=pi/4;
    name=['mwg_sym_compare_n_' num2str(min(n_m)) '_to_' num2str(max(n_m)) '_s_' num2str(steps) '_t_' num2str(t) '_N_' num2str(max(N_m)) '_pauli_ladder'];
    ...
    for h=1:length(N_m)
        ...
        for i=1:length(n_m)
            ...
            other_gates2=Comp_Gate_Merger(other_gates,init,outit,init2,outit2,symit,con,outit);  
            ...
            for l=1:steps
                ...
                trott_gate=MWG_Strang_Trotter_InOut(t,connections,[],l,'','',sizle,anc_size,gate_names );
