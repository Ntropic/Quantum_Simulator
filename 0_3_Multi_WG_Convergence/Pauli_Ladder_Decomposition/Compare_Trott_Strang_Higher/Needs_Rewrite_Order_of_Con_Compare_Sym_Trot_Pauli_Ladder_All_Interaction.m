%Compare_Photon_Numbers_Circ_Pauli_Ladder_All_Interaction.m
clear all;
close all;
clc;
...
higher_name=['higher_compare_n_' num2str(min(n_m)) '_to_' num2str(max(n_m)) '_s_' num2str(steps) '_t_' num2str(t) '_r_' num2str(r_h) '_pauli_gray'];
higher_name2=['higher_compare_n_' num2str(min(n_m)) '_to_' num2str(max(n_m)) '_s_' num2str(steps) '_t_' num2str(t) '_r_' num2str(r_h2) '_pauli_gray'];
...
drawnow;
matlab2tikz(['conv__pauli_gray_all_comp_n_' num2str(n) '.tex'],'figurehandle',h)
