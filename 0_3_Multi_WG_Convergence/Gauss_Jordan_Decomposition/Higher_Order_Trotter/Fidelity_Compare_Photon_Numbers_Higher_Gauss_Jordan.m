...
name=['mwg_higher_compare_fid_n_' num2str(min(n_m)) '_to_' num2str(max(n_m)) '_s_' num2str(steps) '_t_' num2str(t) '_r_' num2str(rec_order) '_N_' num2str(max(N_m)) '_gj'];
...
for h=1:length(N_m)
    ...
    for i=1:length(n_m)
        ...
        for l=1:steps
            ...
            U_approx=U2MWG_Higher_Trotter(H,t,l,rec_order,N);
