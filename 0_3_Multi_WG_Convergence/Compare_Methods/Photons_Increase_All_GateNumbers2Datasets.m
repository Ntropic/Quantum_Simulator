...
%How many more Trotter steps are needed when adding another Photon
clear all;
close all;
clc;
...
for st=st2
    ...
    for i=2:size(F_av_ind2,1) %Waveguides
...
matlab2tikz(['increase_photons_' exits{method} '_' num2str(time_step) '_stand.tex'],'standalone',true,'parsestrings',false,'width','5cm','height','4cm')