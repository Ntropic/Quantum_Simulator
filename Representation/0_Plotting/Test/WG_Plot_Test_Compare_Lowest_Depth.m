%WG_Plot_Test_Compare_Lowest_Depth.m
clc;
clear all;
close all;
...
phi_a=Gate2Matrix_Return_Wave( phi0, elem_gates, other_gates, other_gates(ind(2)), expand_how_deep );
phi_a_red=phi_a(indexes,:);
ta=linspace(0,t,size(phi_a,2));
...
WG_Plot2PColor_Compare( ket_string,[],phi_i_red,phi_a_red,ts,ta,1,1,20);