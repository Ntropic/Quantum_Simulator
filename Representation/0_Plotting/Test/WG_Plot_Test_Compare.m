...
[phi_a,ta] = Expansion2Matrix_Return_Wave(phi0,other_gates(ind(2)),s_e,d_e);   %1=single error 10=double error
...
WG_Plot2PColor_Compare( ket_string,[],phi_i_red,phi_a_red,ts,ta,1);